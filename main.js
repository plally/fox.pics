...
var $author$project$Main$GotFox = function (a) {
	return {$: 'GotFox', a: a};
};
...
var $author$project$Main$foxDecoder = A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string);
...
var $author$project$Main$requestNewFox = $elm$http$Http$get(
	{
		expect: A2($elm$http$Http$expectJson, $author$project$Main$GotFox, $author$project$Main$foxDecoder),
		url: 'https://fox.foxorsomething.net/random.json'
	});
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2($author$project$Main$Loading, $author$project$Main$requestNewFox);
};
...
var $author$project$Main$writeClipboard = _Platform_outgoingPort('writeClipboard', $elm$json$Json$Encode$string);
		...
		switch (msg.$) {
			case 'CopyToClipboard':
				if (model.$ === 'Success') {
					...
					return _Utils_Tuple2(
						model,
						$author$project$Main$writeClipboard(url));
				} else {
			...
			default:
				...
				if (result.$ === 'Ok') {
					var foxId = result.a;
					return _Utils_Tuple2(
						$author$project$Main$Success('https://fox.foxorsomething.net/' + (foxId + '.png')),
...
var $author$project$Icons$copyToClipboard = A2(
	$elm$svg$Svg$svg,
	_List_fromArray(
		[
			...
			$elm$svg$Svg$Attributes$class('feather feather-clipboard')
		]),
	_List_fromArray(
		[
			A2(
...
var $author$project$Icons$newFox = A2(
	...
	_List_fromArray(
		[
			...
			$elm$svg$Svg$Attributes$strokeLinecap('round'),
			$elm$svg$Svg$Attributes$strokeLinejoin('round'),
			$elm$svg$Svg$Attributes$class('feather feather-rotate-cw')
		]),
	_List_fromArray(
		[
			A2(
			...
			return $author$project$Main$container(
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('fox-container')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('fox-img'),
										$elm$html$Html$Attributes$src(foxUrl)
									]),
								_List_Nil)
							]))
					]));
